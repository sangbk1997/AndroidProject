...
/**
 * Created by Sangbk on 12/18/2017.
 */
...
/**
 * Created by Sangbk on 12/12/2017.
 */

public class RestaurantHelper extends android.database.sqlite.SQLiteOpenHelper {
    ...
    public Cursor getById(String id) {
        ...
        return(getReadableDatabase()
                .rawQuery("SELECT _id, name, address, type, notes FROM listRestaurant where _id='?'",args));
    }
