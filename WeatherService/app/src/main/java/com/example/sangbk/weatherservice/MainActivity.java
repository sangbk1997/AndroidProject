package com.example.sangbk.weatherservice;
...
public class MainActivity extends AppCompatActivity {
    ...
    ServiceConnection weatherServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            Weather.LocalWeatherBinder binder = (Weather.LocalWeatherBinder) service;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherText = (TextView) this.findViewById(R.id.text);
        locationText = (EditText)this.findViewById(R.id.location);
    }
